...
const LeaderboardLoadingPage = () => {
  ...
  return (
    <div className="w-3/4 mx-auto flex flex-col gap-5 justify-center z-0">
      <Skeleton className="w-3/10 h-6 bg-zinc-700 z-0" />
      <div className="w-full mx-auto flex flex-col gap-5 justify-center z-0 items-center">
        <Skeleton
          className="w-full h-fit border-[2px] border-zinc-800 rounded-lg
       bg-zinc-700 flex flex-col justify-between z-0"
        >
        ...
        <div className="flex gap-3 items-center">
          <Skeleton className="bg-zinc-800 w-24 h-6" />
          <Skeleton className="bg-zinc-800 w-9 h-9" />
          <Skeleton className="bg-zinc-800 w-24 h-6" />
        </div>
      </div>
    </div>
